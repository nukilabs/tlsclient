...
var _ net.PacketConn = &h3Conn{}

func newH3Conn(str http3Stream, local net.Addr) *h3Conn {
	c := &h3Conn{
		str:       str,
		localAddr: local,
...
func (c *h3Conn) WriteTo(p []byte, _ net.Addr) (n int, err error) {
...
func (c *h3Conn) LocalAddr() net.Addr {
...
func (c *h3Conn) SetReadBuffer(bytes int) error {
	return nil
}

func (c *h3Conn) SetWriteBuffer(bytes int) error {
	return nil
}
