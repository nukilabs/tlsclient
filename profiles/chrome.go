...
//go:generate go run ../tools/trustanchors -out trustanchors.go
...
var Chrome146 = Chrome133

var Chrome147 = Chrome133

var Chrome148 = Chrome133

var Chrome149 = Chrome133

var Chrome150 = ClientProfile{
	ClientHelloSpec: func() *tls.ClientHelloSpec {
		return &tls.ClientHelloSpec{
			CipherSuites: []uint16{
				tls.GREASE_PLACEHOLDER,
...
var Chrome151 = Chrome150

var Chrome152 = ClientProfile{
	ClientHelloSpec: func() *tls.ClientHelloSpec {
		// Chrome advertises the root store anchors in a randomised order rather than one
		// derived from the root store itself.
		anchors := slices.Clone(chromerootstoreanchors)
		...
		return &tls.ClientHelloSpec{
			...
			Extensions: tls.ShuffleChromeTLSExtensions([]tls.TLSExtension{
				...
				&tls.TrustAnchorsExtension{TrustAnchors: anchors},
				&tls.SessionTicketExtension{},
				&tls.SupportedPointsExtension{SupportedPoints: []byte{0x00}},
				&tls.SignatureAlgorithmsExtension{SupportedSignatureAlgorithms: []tls.SignatureScheme{
					tls.GREASE_PLACEHOLDER,
